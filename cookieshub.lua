...
--// ============================================================
--// EXTRACTED PERFORMANCE / DEFENSE SOURCES
--// Anti Lag + FPS Boost + Infinite Jump
--// ============================================================
...
-- Infinite Jump (extracted from the other Cookies Hub source)
...
-- FPS Boost (extracted/adapted from the other Cookies Hub source)
...
-- Anti Lag (extracted/adapted from the other Cookies Hub source)
...
local Colors = {
    ...
    Red = Color3.fromRGB(255, 45, 125),
    RedLight = Color3.fromRGB(255, 105, 190),

    Blue = Color3.fromRGB(70, 220, 255),
    Green = Color3.fromRGB(60, 255, 170),
    Yellow = Color3.fromRGB(255, 230, 80),
    NeonPurple = Color3.fromRGB(180, 80, 255),
    NeonCyan = Color3.fromRGB(50, 245, 255),
...
MainShadow.Size = UDim2.new(1, 18, 1, 18)
MainShadow.Position = UDim2.fromOffset(-9, 10)
...
createCorner(MainShadow, 18)
MainShadow:FindFirstChildOfClass("UICorner").Parent = MainShadow

createCorner(Main, 14)
createStroke(Main, Colors.Red, 2)
...
HeaderGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Colors.Red),
    ColorSequenceKeypoint.new(0.45, Colors.NeonPurple),
...
HeaderStroke.Color = Colors.NeonCyan
...
FPSLabel.Size = UDim2.fromOffset(86, 30)
FPSLabel.Position = UDim2.new(1, -180, 0, 13)
FPSLabel.BackgroundColor3 = Color3.fromRGB(10, 10, 18)
FPSLabel.BackgroundTransparency = 0.08
FPSLabel.Text = "FPS  --"
FPSLabel.Font = Enum.Font.GothamBlack
FPSLabel.TextSize = 13
FPSLabel.TextColor3 = Colors.NeonCyan
FPSLabel.TextXAlignment = Enum.TextXAlignment.Center
FPSLabel.Parent = Header
createCorner(FPSLabel, 9)
local FPSStroke = Instance.new("UIStroke")
FPSStroke.Color = Colors.NeonCyan
FPSStroke.Thickness = 1
FPSStroke.Transparency = 0.25
...
FPSGradient.Parent = FPSLabel

-- Always-visible FPS widget outside the menu
local ExternalFPS = Instance.new("TextLabel")
ExternalFPS.Name = "CookiesExternalFPS"
ExternalFPS.AnchorPoint = Vector2.new(1, 0)
ExternalFPS.Position = UDim2.new(1, -14, 0, 14)
ExternalFPS.Size = UDim2.fromOffset(118, 42)
ExternalFPS.BackgroundColor3 = Color3.fromRGB(7, 7, 14)
ExternalFPS.BackgroundTransparency = 0.10
ExternalFPS.BorderSizePixel = 0
ExternalFPS.Text = "FPS  --"
ExternalFPS.Font = Enum.Font.GothamBlack
ExternalFPS.TextSize = 18
ExternalFPS.TextColor3 = Colors.NeonCyan
ExternalFPS.TextStrokeTransparency = 0.35
ExternalFPS.TextXAlignment = Enum.TextXAlignment.Center
ExternalFPS.ZIndex = 2000
ExternalFPS.Parent = ScreenGui
createCorner(ExternalFPS, 12)

local ExternalStroke = Instance.new("UIStroke")
ExternalStroke.Color = Colors.NeonCyan
ExternalStroke.Thickness = 1.5
ExternalStroke.Transparency = 0.15
ExternalStroke.Parent = ExternalFPS

local ExternalGradient = Instance.new("UIGradient")
ExternalGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Colors.NeonCyan),
    ColorSequenceKeypoint.new(0.5, Colors.NeonPurple),
    ColorSequenceKeypoint.new(1, Colors.Red),
})
ExternalGradient.Parent = ExternalFPS

task.spawn(function()
    while ExternalFPS.Parent do
        ExternalGradient.Rotation = (ExternalGradient.Rotation + 2) % 360
        task.wait(0.03)
    end
end)
